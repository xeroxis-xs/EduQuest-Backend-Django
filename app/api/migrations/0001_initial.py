    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(related_name='quests_participated', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Badge',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_answers', models.ManyToManyField(related_name='selected_by', to='api.answer')),
